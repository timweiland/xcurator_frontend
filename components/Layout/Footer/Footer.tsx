...
const XCuratorLogo = (props): JSX.Element => (
  <BeakerIcon {...props} />
)
...
const links: Link[] = [
  ...
  { name: 'Baden State Museum', href: 'https://www.landesmuseum.de/', left: true},
...
const RowLink = (link: Link): JSX.Element => (
  <Link href={link.href} key={link.name}>
    <a className="font-semibold after:content-['|'] after:mx-1 last:after:content-['']">{link.name}</a>
  </Link>
)
